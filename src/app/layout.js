...
export const metadata = {
  ...
  keywords: [
    ...
    "entreprise nettoyage Annecy",
    "société nettoyage Annecy",
    "nettoyage bureaux Annecy",
    "nettoyage commercial Annecy",
    "vitrerie Annecy",
    "entreprise de nettoyage Sillingy",
    "nettoyage Annecy-le-Vieux",
    "nettoyage Cran-Gevrier",
    "nettoyage Seynod",
    "entreprise nettoyage Haute-Savoie",
    "nettoyage locaux professionnels Annecy",
    "entretien bureaux Annecy",
    "nettoyage locaux médicaux Annecy",
    "entreprise nettoyage 74",
  ],
  robots: {
    index: true,
    follow: true,
